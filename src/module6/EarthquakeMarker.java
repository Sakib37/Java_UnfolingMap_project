...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker another)
	{
		...
		Float anotherMagnitude = another.getMagnitude();
		if (thisMagnitude.compareTo(anotherMagnitude) < 0){
			return 1;
		}
		else if(thisMagnitude.compareTo(anotherMagnitude) > 0){
			return -1;
		}
		else {
			return 0;
	...
	{
		return getTitle();
		//return Float.toString(getRadius());
	}
	/*
